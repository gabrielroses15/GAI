...
def StrongVerbs(frase: str, actionVerbs: dict, dicio, words: list, nomes:list, infinitivos:str, verbs:list, testing:bool=True):
    ...
    for verbos in verbosForces[1]:
        if type(verbos) == list:
            ...
            if len(nomesEncontrados) <= i and nomesEncontrados != []:
                ...
                print("O verbo {} pertence a nenhuma pessoa, que contém {} de força(importância) na frase".format(verbos, verbosForces[0][i]))
    ...
    if 1 in contexto_count.values():
        ...
        for pergunta in perguntas:
            ...
            try:
                ...
                errorAnswer = StrongVerbs(errorQuest + pergunta + " ele", actionVerbs, dicio, errorQuest.split(), nomes, raizes.raiz(" ".join(errorQuest.split()), fMap.verbosList()), verbs, testing)
